...
extension ASN1 {
    ...
    ///
    /// ```swift
    /// let name: ASN1.ASN1ObjectIdentifier = [2, 5, 4, 41]
    /// ```
    ///
    ...
    public struct ASN1ObjectIdentifier: ASN1ImplicitlyTaggable {
        @inlinable
...
extension ASN1.ASN1ObjectIdentifier: Sendable { }
...
extension ASN1.ASN1ObjectIdentifier {
    ...
    public enum NamedCurves {
        ...
        public static let secp256r1: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 10_045, 3, 1, 7]

        /// Represents the NIST P384 curve.
        public static let secp384r1: ASN1.ASN1ObjectIdentifier = [1, 3, 132, 0, 34]

        /// Represents the NIST P521 curve.
        public static let secp521r1: ASN1.ASN1ObjectIdentifier = [1, 3, 132, 0, 35]
    }
    ...
    public enum AlgorithmIdentifier {
        ...
        public static let idEcPublicKey: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 10_045, 2, 1]
        ...
        public static let sha256WithRSAEncryption: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 11_3549, 1, 1, 11]

        /// Identifies a PKCS#1v1.5 RSA signature using SHA384 as the hash algorithm.
        ///
        /// This identifier is defined in RFC 4055. When used, the parameters MUST be NULL.
        public static let sha384WithRSAEncryption: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 11_3549, 1, 1, 12]

        /// Identifies a PKCS#1v1.5 RSA signature using SHA512 as the hash algorithm.
        ///
        /// This identifier is defined in RFC 4055. When used, the parameters MUST be NULL.
        public static let sha512WithRSAEncryption: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 11_3549, 1, 1, 13]
        ...
        /// defined in that RFC.
        public static let rsaPSS: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 11_3549, 1, 1, 10]

        /// Identifies an RSA public key.
        ///
        /// This identifier is defined in RFC 4055. When used, the parameters MUST be NULL.
        public static let rsaEncryption: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 11_3549, 1, 1, 1]
    }
    ...
    public enum NameAttributes {
        ...
        public static let title: ASN1.ASN1ObjectIdentifier = [2, 5, 4, 12]
        ...
        public static let dnQualifier: ASN1.ASN1ObjectIdentifier = [2, 5, 4, 46]
        ...
        /// devices.
        public static let serialNumber: ASN1.ASN1ObjectIdentifier = [2, 5, 4, 5]

        /// The pseudonym attribute type contains a pseudonym of the subject.
        public static let pseudonym: ASN1.ASN1ObjectIdentifier = [2, 5, 4, 65]
        ...
        public static let domainComponent: ASN1.ASN1ObjectIdentifier = [0, 9, 2342, 19200300, 100, 1, 25]
        ...
        public static let emailAddress: ASN1.ASN1ObjectIdentifier = [1, 2, 840, 113549, 1, 9, 1]
    }
    ...
    public enum OCSP {
        ...
        public static let basicResponse: ASN1.ASN1ObjectIdentifier = [1, 3, 6, 1, 5, 5, 7, 48, 1, 1]
    }
}
