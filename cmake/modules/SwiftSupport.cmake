...
if(NOT SwiftASN1_SWIFTMODULE_TRIPLE)
  ...
  set(SwiftASN1_SWIFTMODULE_TRIPLE "${module_triple}" CACHE STRING "Triple used to install Swift module files")
  mark_as_advanced(SwiftASN1_SWIFTMODULE_TRIPLE)
...
function(_install_target module)
  ...
  install(FILES $<TARGET_PROPERTY:${module},Swift_MODULE_DIRECTORY>/${module_name}.swiftdoc
    ...
    RENAME ${SwiftASN1_SWIFTMODULE_TRIPLE}.swiftdoc)
  install(FILES $<TARGET_PROPERTY:${module},Swift_MODULE_DIRECTORY>/${module_name}.swiftmodule
    DESTINATION lib/${swift}/${swift_os}/${module_name}.swiftmodule
    RENAME ${SwiftASN1_SWIFTMODULE_TRIPLE}.swiftmodule)
endfunction()
